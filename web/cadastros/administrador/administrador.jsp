                ...
                <tbody>
                    <c:forEach var="administrador" items="${administradores}">
                        <tr>
                            ...
                            <td aligh="center">${administrador.cidade.nomeCidade}-${administrador.cidade.estado.siglaEstado}</td>                            </td>
                            <td align="center">
                                <a href="#modaladicionar" class="btn btn-success adicionar" data-toggle="modal" data-id="" 
                                   onclick="setDadosModal(${administrador.idAdministrador})">
                                    <i class="fas fa-plus fa-fw"></i>
                                    Alterar
                                </a>
                            </td>
                            <td align="center">
                                <a href="#" onclick="deletar(${administrador.idAdministrador})">
                                    <button class="btn <c:out value="${administrador.situacao == 'A' ? 'btn-danger' : 'btn-success'}"/>">
                                        <i class="fas fa-fw <c:out value="${administrador.situacao == 'A' ? 'fa-times' : 'fa-plus'}"/>"></i>
                                        <strong>
                            ...
                            function (data) {
                                if (data == 1) {
                                    ...
                                    Swal.fire({
                                        ...
                                        icon: 'error',
                                        title: 'Erro',
                                        text: 'Não foi possivel inativar administrador!',
                                        showConfirmButton: true,
                                        timer: 10000
                                    }).then(function () {
                                        window.location.href = "${pageContext.request.contextPath}/AdministradorListar";
                    ...
                    function (data) {
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Não foi possivel gravar o administrador!',
                                showConfirmaButton: true,
                                timer: 10000
                            }).then(function () {
                                window.location.href = "${pageContext.request.contextPath}/AdministradorListar";
