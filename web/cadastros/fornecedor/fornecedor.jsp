                ...
                <tbody>
                    <c:forEach var="fornecedor" items="${fornecedores}">
                        <tr>
                            ...
                            <td aligh="center">${fornecedor.cidade.nomeCidade}-${fornecedor.cidade.estado.siglaEstado}</td>                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <a href="#" onclick="deletar(${fornecedor.idFornecedor})">
                                    <button class="btn <c:out value="${fornecedor.situacao == 'A' ? 'btn-danger' : 'btn-success'}"/>">
                                        <i class="fas fa-fw <c:out value="${fornecedor.situacao == 'A' ? 'fa-times' : 'fa-plus'}"/>"></i>
                                        <strong>
                            ...
                            function (data) {
                                if (data == 1) {
                                    ...
                                    Swal.fire({
                                        ...
                                        icon: 'error',
                                        title: 'Erro',
                                        text: 'Não foi possivel inativar Fornecedor!',
                                        showConfirmButton: true,
                                        timer: 10000
                                    }).then(function () {
                                        window.location.href = "${pageContext.request.contextPath}/FornecedorListar";
                    ...
                    function (data) {
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Não foi possivel gravar o Fornecedor!',
                                showConfirmaButton: true,
                                timer: 10000
                            }).then(function () {
                                window.location.href = "${pageContext.request.contextPath}/FornecedorListar";
