    ...
    <tbody>
        <c:forEach var="estado" items="${estados}">
            <tr>
                ...
                <td align="center">
                    <a href="${pageContext.request.contextPath}/EstadoExcluir?idEstado=${estado.idEstado}">Excluir</a>
                </td>
                <td align="center">
                    <a href="${pageContext.request.contextPath}/EstadoCarregar?idEstado=${estado.idEstado}">Alterar</a>
                </td>
            </tr>
        </c:forEach>
    </tbody>
...
<div align="center">
    ...
    <a href="index.jsp">Voltar á Página Inicial</a>
</div>
    <script>
