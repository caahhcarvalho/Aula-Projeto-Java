...
public class DespesaDAO implements GenericDAO {
    ...
    public Boolean inserir(Object objeto) {
        ...
        String sql = "insert into despesa (descricao,valorDespesa, valorPago, datadocumento, imagemdocumento)"
                + "values (?,?,?,?,?)";
        try {
    ...
    public Boolean excluir(int numero) {
        ...
        try {
            ...
            try {
                System.out.println("Problemas ao escluir Despesa! Erro: " + e.getMessage());
                e.printStackTrace();
                conexao.rollback();
            } catch (SQLException ex) {
                System.out.println("Problemas ao executar rollback" + ex.getMessage());
