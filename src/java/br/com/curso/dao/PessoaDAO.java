...
public class PessoaDAO {
    ...
    public int inserir(Object objeto) {
        ...
        try {
            ...
            try {
                System.out.println("Problemas ao Cadatrar Pessoa na DAO!Erro: " + e.getMessage());
                e.printStackTrace();
                conexao.rollback();
    ...
    public Pessoa carregarCpf(String cpf) throws ParseException{
        ...
        try{
            ...
            System.out.println("Problemas ao CarregarCPF Pessoa na PessoaDAO! Erro: "+ex.getMessage());
        }
        return oPessoa;
    }
}
