...
public class FornecedorCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Fornecedor oFornecedor = new Fornecedor(idFornecedor,enderecoWeb, situacao, permiteLogin, idPessoa, cpfCnpjPessoa,
            ...
            System.out.println("Problemas ao Cadastrar Fornecedor no Servlet! Erro: "+e.getMessage());
            e.printStackTrace();
        }
    }
