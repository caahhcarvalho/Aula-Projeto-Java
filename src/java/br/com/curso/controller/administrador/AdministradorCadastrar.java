...
public class AdministradorCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Administrador oAdministrador = new Administrador(idAdministrador, permiteLogin, situacao, idPessoa, cpfCnpjPessoa,
                    nomePessoa, dataNascimento, oCidade, login, senha, fotoPessoa);
            ...
            System.out.println("Problemas ao Cadastrar Administrador no Servlet! Erro: "+e.getMessage());
            e.printStackTrace();
        }
    }
