...
public class ClienteCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Cliente oCliente = new Cliente(idCliente, observacao, permiteLogin, situacao, idPessoa, cpfCnpjPessoa,
            ...
            System.out.println("Problemas ao Cadastrar Cliente no Servlet! Erro: "+e.getMessage());
            e.printStackTrace();
        }
    }
