...
<form name="cadastrarcidade" action="CidadeCadastrar" method="POST">
    <table align="center" boder="0">
        <thead>
            <tr>
                <th colspan="2" align="center">Cadasto de Cidade</th>
            </tr>
            <tr>
        ...
        <tbody>
            <tr>
                <td>ID: </td>
                <td>
                    <input type="text" name="idcidade" id="idcidade" value="${cidade.idCidade}" readonly="readonly"/>
                </td>
            </tr>
            <tr>                
                <td>Nome: </td>
                <td>
                    <input type="text" name="nomecidade" id="nomecidade" value="${cidade.nomeCidade}" size="50" max="50"/>
                </td>
            </tr>
            <tr>
                <td>Estado: </td>
