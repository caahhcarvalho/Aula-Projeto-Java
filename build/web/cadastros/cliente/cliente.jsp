...
<div class="container-fluid">
    ...
    <a href="#modaladicionar" class="btn btn-success mb-4 adicionar" data-toggle="modal" data-id="" 
       onclick="setDadosModal(${0})">
                ...
                <tbody>
                    <c:forEach var="cliente" items="${clientes}">
                        <tr>
                            ...
                            <td aligh="center">${cliente.cidade.nomeCidade}-${cliente.cidade.estado.siglaEstado}</td>                            </td>
                            <td align="center">
                                <a href="#modaladicionar" class="btn btn-success adicionar" data-toggle="modal" data-id="" 
                                   onclick="setDadosModal(${cliente.idCliente})">
                                    <i class="fas fa-plus fa-fw"></i>
                                    Alterar
                                </a>
                            </td>
                            <td align="center">
                                <a href="#" onclick="deletar(${cliente.idCliente})">
                                    <button class="btn <c:out value="${cliente.situacao == 'A' ? 'btn-danger' : 'btn-success'}"/>">
                                        <i class="fas fa-fw <c:out value="${cliente.situacao == 'A' ? 'fa-times' : 'fa-plus'}"/>"></i>
                                        <strong>
    ...
    <div class="modal fade" id="modaladicionar" tabindex="-1" arie-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nome</label>
                        <input class="form-control" type="text" name="nomepessoa" id="nomepessoa" value=""/>
                    </div>
                    <div class="form-group">
                        <label>Observação</label>
                        <input class="form-control" type="text" name="observacao" id="observacao" value=""/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sedondary" data-dismiss="modal">Cancelar</button>
                            ...
                            function (data) {
                                if (data == 1) {
                                    ...
                                    Swal.fire({
                                        ...
                                        icon: 'error',
                                        title: 'Erro',
                                        text: 'Não foi possivel inativar Cliente!',
                                        showConfirmButton: true,
                                        timer: 10000
                                    }).then(function () {
                                        window.location.href = "${pageContext.request.contextPath}/ClienteListar";
                    ...
                    function (data) {
                        ...
                        if (data == 1) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                title: 'Erro',
                                text: 'Não foi possivel gravar o Cliente!',
                                showConfirmaButton: true,
                                timer: 10000
                            }).then(function () {
                                window.location.href = "${pageContext.request.contextPath}/ClienteListar";
